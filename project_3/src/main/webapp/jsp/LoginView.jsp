...
.p4 {
	background-image: url('<%=ORSView.APP_CONTEXT%>/img/login.webp');
	background-size: cover;
...
<!-- 							 session tracking through url rewriting
 --> 							
							<%-- <%
							String enUrl = response.encodeURL("/Catalog");
							
							%>
							<a href="<%=enUrl%>">Encoded Link</a> 
							
							
							<a href="MySession.jsp?jsessionid=<%=session.getId()%>">Simle_link</a>  --%>
